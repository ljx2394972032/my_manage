...
import com.vigekoo.manage.sys.entity.SysColumn;
import com.vigekoo.manage.sys.entity.SysTable;
import com.vigekoo.manage.utils.DateUtils;
...
public class GeneratorUtils {
    ...
    public static String getFileName(String template, String className, String classname, String packageName) {
        ...
        if (template.contains("Dao.java.vm")) {
            return packagePath + File.separator + "admin" + File.separator + "dao" + File.separator + className + "Dao.java";
        }

        if (template.contains("Service.java.vm")) {
            return packagePath + File.separator + "admin" + File.separator + "service" + File.separator + className + "AdminService.java";
        }

        if (template.contains("ServiceImpl.java.vm")) {
            return packagePath + File.separator + "admin" + File.separator + "service" + File.separator + "impl" + File.separator + className + "AdminServiceImpl.java";
        }

        if (template.contains("Controller.java.vm")) {
            return packagePath + File.separator + "admin" + File.separator + "controller" + File.separator + className + "AdminController.java";
        }

        if (template.contains("Dao.xml.vm")) {
            return "main" + File.separator + "resources" + File.separator + "mapper" + File.separator + "admin" + File.separator + className + "Mapper.xml";
        }

        if (template.contains("list.html.vm")) {
            return "main" + File.separator + "resources" + File.separator + "views" + File.separator
                    + "modules" + File.separator + "admin" + File.separator + classname + ".html";
        }

        if (template.contains("list.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js" + File.separator
                    + "modules" + File.separator + "admin" + File.separator + classname + ".js";
        }
        return null;
    }
}
