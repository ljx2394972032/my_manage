...
/**
 * @author ljx
 * @Description: (shiro 认证过滤器)
 * @date 2017-6-23 15:07
 */
public class ShiroAuthenticatingFilter extends AuthenticatingFilter {
    protected static final Logger log = LoggerFactory.getLogger(ShiroAuthenticatingFilter.class);
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if (StringUtils.isBlank(token)) {
            ...
            String json = new Gson().toJson(Result.error(HttpStatus.SC_UNAUTHORIZED, "token failure!"));
